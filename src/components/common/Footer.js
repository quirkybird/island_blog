    ...
    <footer className="p-5 w-full shadow-[rgba(0,0,0,0.1)_0px_10px_50px]">
      <div className="lg:w-[70vw] flex sm:justify-between justify-center flex-wrap items-center m-auto">
        <div className="flex items-center text-[12px] lg:text-base">
          <div className="whitespace-nowarp shrink-0">
            {`© ${new Date().getFullYear()} quirkybird 版权所有`}
          </div>
          <div className="flex lg:ml-5 ml-3 items-center">
            <img
              className="w-8"
              src={require("../../assets/images/icon120.png")}
              alt="萌国icon"
            />
            <a
              href="https://icp.gov.moe/?keyword=20236776"
              target="_blank"
        ...
        <div className="self-end p-2  flex items-center flex-wrap justify-center">
...
export const ThemeButton = () => {
  ...
  useEffect(() => {
    ...
    switch (theme) {
      case "light":
        container.children[0].style.color = "#60A5FA";
        break;
      case "dark":
        container.children[1].style.color = "#60A5FA";
        break;
      case null:
        container.children[2].style.color = "#60A5FA";
        break;
      default:
        container.children[0].style.color = "#60A5FA";
    }
  ...
  return (
    <div
      ref={containerRef}
      className="w-24 h-8 mx-5 outline-1 outline rounded-md flex items-center"
    >
      <span
        className="flex-1 inline-block pl-1 cursor-pointer"
        data-theme-id="themeLight"
      >
        <svg
      ...
      <span
        className="flex-1 inline-block pr-1 cursor-pointer"
        data-theme-id="themeOs"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          height="24"
